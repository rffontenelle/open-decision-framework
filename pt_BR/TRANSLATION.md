...
* Essa versão de marcação dos slides destina-se a facilitar a colaboração e o rastreamento de alterações.
* A numeração de páginas corresponde aos arquivos LibreOffice (.odp) e PDF no repo.
